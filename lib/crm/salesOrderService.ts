...
import { calculateTotals } from "./salesOrderCalculations";
export { approveSalesOrder, reserveInventory, releaseReservation, cancelSalesOrder, closeSalesOrder } from "./salesOrderWorkflow";
...
export async function updateSalesOrder(companyId: string, id: string, userId: string, data: any) {
  ...
  if (
    ...
    throw new Error("Cannot modify a Sales Order that is Cancelled or Closed");
  }
