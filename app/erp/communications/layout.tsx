...
export default function CommunicationsLayout({
  ...
  const navigation = [
    { name: 'Inbox', href: '/erp/communications', icon: Inbox, exact: true },
    { name: 'Announcements', href: '/erp/communications/announcements', icon: Megaphone, exact: false },
    { name: 'Templates', href: '/erp/communications/templates', icon: FileText, exact: false },
    { name: 'Preferences', href: '/erp/communications/preferences', icon: Settings, exact: false },
  ];
