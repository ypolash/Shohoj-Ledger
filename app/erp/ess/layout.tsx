...
export default function EssLayout({
  ...
  const tabs = [
    { name: 'My Profile', path: '/erp/ess/profile', icon: 'person' },
    { name: 'My Documents', path: '/erp/ess/documents', icon: 'description' },
    { name: 'My Attendance', path: '/erp/ess/attendance', icon: 'how_to_reg' },
