    ...
    <div className="animate-fade-in container" style={{ maxWidth: '1400px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: "var(--spacing-6)" }}>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <Link href="/erp/staff-management/payroll/reports">
                      ...
                      <tr key={pay.id} className={styles.clickableRow} style={isSelected ? { background: 'rgba(59,130,246,0.05)' } : {}}>
                        ...
                        <td>
                          <div style={{ display: 'flex', gap: '6px', justifyContent: 'center' }}>
                            ...
                            <Link href={`/erp/staff-management/payroll/payslip/${pay.id}`}>
      ...
      <PayrollHistoryModal {...{ isHistoryModalOpen, setIsHistoryModalOpen, loadingAudits, auditLogs }} />
