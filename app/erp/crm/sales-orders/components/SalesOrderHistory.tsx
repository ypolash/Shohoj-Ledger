...
export function SalesOrderHistory() {
  const logs = [
    { id: 1, action: 'Status updated to Shipped', user: 'Jane Smith', date: '2026-07-25 11:30 AM' },
    { id: 2, action: 'Order Confirmed from Quotation', user: 'Jane Smith', date: '2026-07-24 10:15 AM' },
  ];
