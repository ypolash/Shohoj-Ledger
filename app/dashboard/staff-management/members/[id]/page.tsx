  ...
  if (error || !member) {
    return (
      <div style={{ padding: '40px', textAlign: 'center', color: 'var(--danger)' }}>
        ...
        <button className="btn btn-secondary" onClick={() => router.push('/dashboard/staff-management/members')} style={{ marginTop: '16px' }}>Back to Members</button>
      </div>
    );
  }
  ...
  return (
    <div className="animate-fade-in" style={{ padding: '24px', maxWidth: '1000px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div style={{ marginBottom: '-8px' }}>
        <Link href="/dashboard/staff-management/members" style={{ color: 'var(--text-muted)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '8px', fontSize: '14px', fontWeight: 500, transition: 'color 0.2s' }} onMouseOver={(e) => e.currentTarget.style.color = 'var(--text-main)'} onMouseOut={(e) => e.currentTarget.style.color = 'var(--text-muted)'}>
