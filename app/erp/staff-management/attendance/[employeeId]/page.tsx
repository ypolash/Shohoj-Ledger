  ...
  return (
    <div className="animate-fade-in container" style={{ maxWidth: '1400px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '24px', marginBottom: "var(--spacing-6)" }}>
        <button onClick={() => router.push('/erp/staff-management/attendance')} className="btn btn-secondary" style={{ padding: '8px', borderRadius: '50%', width: '40px', height: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
