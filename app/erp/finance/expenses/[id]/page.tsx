  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '24px' }}>
        <Link href="/erp/finance/expenses/1/edit" style={{ padding: '10px 24px', borderRadius: '8px', background: 'var(--surface-hover)', border: '1px solid var(--border-main)', color: 'var(--text-main)', fontSize: '13px', fontWeight: 600, cursor: 'pointer', textDecoration: 'none' }}>Edit Expense</Link>
      </div>
    </div>
  );
}
