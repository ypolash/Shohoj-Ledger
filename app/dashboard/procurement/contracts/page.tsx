...
export default function ContractsPage() {
  ...
  return (
    <PageContainer>
      <PageHeader 
        title="Contracts" 
        description="Manage enterprise contracts and track supplier metrics."
      />
      <div className="glass-card" style={ padding: 'var(--spacing-6)' }>
        <div style={ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 'var(--spacing-4)' }>
          <h2 style={ margin: 0, fontSize: '18px' }>Contracts Overview</h2>
              ...
              <tr>
                <td colSpan={5} style={ textAlign: 'center', padding: 'var(--spacing-8)', color: 'var(--text-muted)' }>
                  <div style={ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }>
                    ...
                    <p style={ margin: 0 }>No contracts records found.</p>
                  </div>
                </td>
              </tr>
            </tbody>
