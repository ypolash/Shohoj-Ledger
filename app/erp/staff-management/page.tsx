    ...
    <div className="animate-fade-in">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '24px', marginBottom: '32px' }}>
        <div className="glass-card topo-bg" style={{ padding: '24px', borderRadius: '16px' }}>
          ...
          <Link href="/erp/staff-management/employees" style={{ fontSize: '13px', color: '#6366f1', textDecoration: 'none', display: 'inline-block', marginTop: '12px' }}>Manage Employees &rarr;</Link>
        </div>
        ...
        <div className="glass-card topo-bg" style={{ padding: '24px', borderRadius: '16px' }}>
          ...
          <Link href="/erp/staff-management/departments" style={{ fontSize: '13px', color: '#6366f1', textDecoration: 'none', display: 'inline-block', marginTop: '12px' }}>View Departments &rarr;</Link>
        </div>
        ...
        <div className="glass-card topo-bg" style={{ padding: '24px', borderRadius: '16px' }}>
          ...
          <Link href="/erp/staff-management/leave" style={{ fontSize: '13px', color: '#f59e0b', textDecoration: 'none', display: 'inline-block', marginTop: '12px' }}>Review Requests &rarr;</Link>
        </div>
