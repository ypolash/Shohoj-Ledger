...
export default function FinancePage() {
  ...
  return (
    <PageContainer>
      <PageHeader 
        title="Finance" 
        description="Enterprise finance metrics, charts, and analysis."
      />
      <div className="glass-card" style={{ padding: 'var(--spacing-6)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 'var(--spacing-4)' }}>
          <h2 style={{ margin: 0, fontSize: '18px' }}>Finance Dashboard</h2>
              ...
              <tr>
                <td colSpan={4} style={{ textAlign: 'center', padding: 'var(--spacing-8)', color: 'var(--text-muted)' }}>
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
                    ...
                    <p style={{ margin: 0 }}>No finance data available for the selected period.</p>
                  </div>
                </td>
              </tr>
            </tbody>
