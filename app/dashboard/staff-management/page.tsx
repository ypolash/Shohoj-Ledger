    ...
    <div className="animate-fade-in">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '24px', marginBottom: '32px' }}>
        ...
        <div className="glass-card topo-bg" style={{ padding: '24px', borderRadius: '16px' }}>
          ...
          <Link href="/dashboard/staff-management/attendance" style={{ fontSize: '13px', color: '#6366f1', textDecoration: 'none', display: 'inline-block', marginTop: '12px' }}>View Register &rarr;</Link>
        </div>
        ...
        <div className="glass-card topo-bg" style={{ padding: '24px', borderRadius: '16px' }}>
          ...
          <Link href="/dashboard/staff-management/payroll" style={{ fontSize: '13px', color: '#10b981', textDecoration: 'none', display: 'inline-block', marginTop: '12px' }}>Process Payroll &rarr;</Link>
        </div>
      </div>
    </div>
  );
