  ...
  return (
    <PageContainer>
      <PageHeader 
        ...
        description="Manage all SaaS tenants, their business details, and platform access status."
      />
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 'var(--spacing-4)' }}>
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            ...
            <button className="btn btn-primary">
              <span className="material-symbols-outlined">add</span> Create New Tenant
            </button>
          </div>
        </div>
                ...
                <tr>
                  <td colSpan={6} style={{ textAlign: 'center', padding: 'var(--spacing-8)', color: 'var(--text-muted)' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
                      <span className="material-symbols-outlined" style={{ fontSize: '48px', opacity: 0.5 }}>business</span>
                      <p style={{ margin: 0 }}>No tenant records found.</p>
                    </div>
                  </td>
                </tr>
              ) : (
